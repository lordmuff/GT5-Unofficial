...
public class SpaceDimRegisterer {
    ...
    public static void register() {
        ...
        GalacticGregRegistry.registerModContainer(setupNTMSpace());
    }
    ...
    private static ModContainer setupNTMSpace() {
        ModContainers.NTMSpace.modContainer.addDimensionDef(DimensionDef.Neper.modDimensionDef);
        ModContainers.NTMSpace.modContainer.addDimensionDef(DimensionDef.Maahes.modDimensionDef);
        ModContainers.NTMSpace.modContainer.addDimensionDef(DimensionDef.Anubis.modDimensionDef);
        ModContainers.NTMSpace.modContainer.addDimensionDef(DimensionDef.Horus.modDimensionDef);
        ModContainers.NTMSpace.modContainer.addDimensionDef(DimensionDef.Seth.modDimensionDef);
        DimensionDef.MehenBelt.modDimensionDef.addAsteroidMaterial(GTOreTypes.BlackGranite);
        ModContainers.AmunRa.modContainer.addDimensionDef(DimensionDef.MehenBelt.modDimensionDef);
        return ModContainers.AmunRa.modContainer;
    }
