...
public enum GTPP_Branch_Definition {
    ...
    public final IAllele[] getTemplate() {
        ...
        try {
            gtBranchDefClass = Class.forName("gregtech5.loaders.misc.GT_BranchDefinition");
    ...
    private Enum setEnumVar(String value) {
        try {
            Class gtBranchDefClass = Class.forName("gregtech5.loaders.misc.GT_BranchDefinition");
