...
public class MissingMappingsHandler {
    ...
    private static final Remapper REMAPPER = new Remapper()
        ...
        .remapItem("gregtech5:gt.glowstoneCell", ItemList.RodGlowstone.getItem())
        .remapItem("gregtech5:gt.Thoriumcell", ItemList.RodThorium.getItem())
        .remapItem("gregtech5:gt.Double_Thoriumcell", ItemList.RodThorium2.getItem())
        .remapItem("gregtech5:gt.Quad_Thoriumcell", ItemList.RodThorium4.getItem())
        .remapItem("gregtech5:gt.reactorUraniumSimple", ItemList.RodUranium.getItem())
        .remapItem("gregtech5:gt.reactorUraniumDual", ItemList.RodUranium2.getItem())
        .remapItem("gregtech5:gt.reactorUraniumQuad", ItemList.RodUranium4.getItem())
        .remapItem("gregtech5:gt.reactorMOXSimple", ItemList.RodMOX.getItem())
        .remapItem("gregtech5:gt.reactorMOXDual", ItemList.RodMOX2.getItem())
        .remapItem("gregtech5:gt.reactorMOXQuad", ItemList.RodMOX4.getItem())
        ...
        .remapItem("gregtech5:gt.Naquadahcell", ItemList.RodNaquadah.getItem())
        .remapItem("gregtech5:gt.Double_Naquadahcell", ItemList.RodNaquadah2.getItem())
        .remapItem("gregtech5:gt.Quad_Naquadahcell", ItemList.RodNaquadah4.getItem())
        .remapItem("bartworks:gt.Core_Reactor_Cell", ItemList.RodNaquadah32.getItem())
        .remapItem("gregtech5:gt.MNqCell", ItemList.RodNaquadria.getItem())
        .remapItem("gregtech5:gt.Double_MNqCell", ItemList.RodNaquadria2.getItem())
        .remapItem("gregtech5:gt.Quad_MNqCell", ItemList.RodNaquadria4.getItem())
        ...
        .remapItem("gregtech5:gt.sunnariumCell", ItemList.DepletedRodGlowstone.getItem())
        .remapItem("gregtech5:gt.ThoriumcellDep", ItemList.DepletedRodThorium.getItem())
        .remapItem("gregtech5:gt.Double_ThoriumcellDep", ItemList.DepletedRodThorium2.getItem())
        .remapItem("gregtech5:gt.Quad_ThoriumcellDep", ItemList.DepletedRodThorium4.getItem())
        ...
        .remapItem("gregtech5:gt.NaquadahcellDep", ItemList.DepletedRodNaquadah.getItem())
        .remapItem("gregtech5:gt.Double_NaquadahcellDep", ItemList.DepletedRodNaquadah2.getItem())
        .remapItem("gregtech5:gt.Quad_NaquadahcellDep", ItemList.DepletedRodNaquadah4.getItem())
        .remapItem("bartworks:gt.Core_Reactor_CellDep", ItemList.DepletedRodNaquadah32.getItem())
        .remapItem("gregtech5:gt.MNqCellDep", ItemList.DepletedRodNaquadria.getItem())
        .remapItem("gregtech5:gt.Double_MNqCellDep", ItemList.DepletedRodNaquadria2.getItem())
        .remapItem("gregtech5:gt.Quad_MNqCellDep", ItemList.DepletedRodNaquadria4.getItem())
